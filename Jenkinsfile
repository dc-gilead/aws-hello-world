PipelineECS(appName: 'hello-world',
        ...
        unitTestCommand: 'pip install -r test/requirements.txt && export WHO="Brian Carpio" && export WHAT="Is DevOps" && python3 -m pytest --junitxml=test-reports/unit-test.xml && pylint --exit-zero --output-format text --output pylint-report.text hello_world',
